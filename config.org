...
(after! org
  (setq org-agenda-files '(
                           ...
                           ;; doom config, for the pending tasks in it.
                           "~/.doom.d/config.org"
                           )
        )
  )
...
I don't know if this is shown in the doom modeline.
...
This is superseded by the fontaine package.
...
(after! org
  ...
  ;;(define-key org-remark-mode-map (kbd "C-c m j") #'org-remark-change)
