...
(add-to-list 'org-agenda-custom-commands
             '("d" "Daily driver"
               (
                ...
                ;; Waiting — blocked, but worth a nudge if you have time
                (tags-todo "/WAITING"
...
(add-to-list 'org-agenda-custom-commands
             '("f" "Focus — what am I doing right now"
               (
                ...
                (tags-todo "/WAITING"
                           ((org-agenda-overriding-header "[ WAITING — blocked on others ]")
                            (org-agenda-sorting-strategy '(ts-up priority-down))
                            (org-agenda-prefix-format " %i %-16:c ")))
                )
               )
...
#+begin_src emacs-lisp :tangle yes
(message "--- loading work agenda")
(doom/load-session "~/Nextcloud/config/.emacs.d/persp-confs/trabajo")
(message "+++ loaded work agenda")
#+end_src
